...
func getRandomFact() string {
	facts := [...]string{
		...
		"In Hexagon, speed is a virtue",
		"In Asteroids, there is an infinite amount of straight lines passing through two points",
		"It's possible to survive Fury with the bonus score, without shooting. Momos Necto was the first player to accomplish this.",
		...
		"The 2020 PPL Level Jam winner is tavitu!",
